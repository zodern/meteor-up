...
describe('module - meteor', function () {
  ...
  describe('start', function () {
    ...
    it('should start meteor on "meteor" vm', async done => {
      ...
      sh.exec('mup docker setup && mup meteor setup && mup meteor push && mup meteor envconfig', {silent: true});
  ...
  describe('deploy', function () {
    ...
    it('should deploy meteor app on "meteor" vm', async done => {
      ...
      sh.exec('mup docker setup && mup meteor setup', {silent: true});
  ...
  describe('stop', function () {
    ...
    it('should stop meteor app on "meteor" vm', async done => {
      ...
      sh.exec('mup docker setup && mup meteor setup && mup meteor deploy', {silent: true});
